                    ...
                    if (field != null){
                        ...
                        if (card != null){
                            for (Command option: card.command.getOptions()){
                                Button optionButtten = new Button(option.displayName);
                                optionButtten.setOnAction( e -> gameController.executeCommandOptionAndContinue(option));
                                optionButtten.setDisable(false);
                                playerInteractionPanel.getChildren().add(optionButtten);
                            }
                        }
                    }
                }
